...
/* ══════════════ EMPEZANDO RUTINA (4 semanas) ══════════════ */
WORKOUT_PLANS.empezando_rutina = {
  id: 'empezando_rutina',
  name: 'Empezando Rutina',
  description: '4 semanas | Principiantes · Movilidad + Fuerza + HIIT | 7 días/semana',
  planType: 'phased',
  weeks: 4,
  ...
  weeklySchedule: [
    ...
    {
      1: [
        _ex('er_core_dl', 'Core | Deadlifts', 2, '8/lado', 0),
        _ex('er_est_pir', 'Estiramiento | Pirámidal', 2, '30"/lado', 0),
        _ex('er_mob_flex_esc', 'Movilidad | Flexiones escapulares', 2, '10', 0),
        _ex('er_mob_aduct_kb', 'Movilidad | Aductores con kettlebell', 2, '8/lado', 0),
        _ex('er_mob_rot_col', 'Movilidad | Rotación de columna en T', 2, '10/lado', 120),
        _ex('er_mob_deep_squat', 'Movilidad | Deep squat prayer opener', 2, '30"', 0),
      ],
      2: [
        _ex('er_mob_rot_col_d2', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('er_mob_run_lunge', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('er_mob_cab', 'Movilidad | Shoulder CAB', 1, '10', 0),
        _ex('er_mob_kb_halo', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('er_flex_plio', 'Flexiones plométricas con altura', 6, '6-8', 0),
        _ex('er_remo_giron', 'Remo gironda con resistencia', 3, '14', 0),
        _ex('er_press_pecho', 'Press de pecho con resistencia tumbada', 3, '20', 0),
        _ex('er_facepull', 'Facepull con resistencia', 3, '16', 0),
        _ex('er_core_mcgill', 'Core | McGill crunch', 2, '10', 0),
        _ex('er_core_crunch_inv', 'Core | Crunch inverso con disco', 2, '8', 0),
        _ex('er_core_worm', 'Core | Worm walks', 2, '6', 0),
      ],
      3: [
        _ex('er_hiit_burp', 'HIIT | Burpees', 1, '30" trabajo', 30, 'trabajo/descanso'),
        _ex('er_hiit_sprint', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_jump_plank', 'Core | Jumping jacks plank', 1, '30" trabajo', 30),
        _ex('er_hiit_bench_jump', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('er_sq_bulg_jump', 'Sentadilla búlgara con salto', 1, '30" trabajo', 20),
        _ex('er_hiit_burp_r2', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('er_hiit_sprint_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_jump_plank_r2', 'Core | Jumping jacks plank', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('er_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('er_est_split', 'Estiramiento | Split unilateral', 2, '30"/lado', 0),
        _ex('er_est_updog', 'Estiramiento | Upward dog', 2, '6', 0),
        _ex('er_est_hombros', 'Estiramiento | Hombros', 2, '15"/lado', 0),
        _ex('er_est_cadera_frog', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
        _ex('er_mob_flex_tib', 'Movilidad | Flexión tibial con resistencia', 2, '10/lado', 0),
        _ex('er_mob_leg_rock', 'Movilidad | Leg Rockback', 2, '8/lado', 0),
        _ex('er_mob_scorp', 'Movilidad | Scorpions', 2, '10/lado', 0),
        _ex('er_mob_flex_tobi_peso', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
      5: [
        _ex('er_mob_cossak', 'Movilidad | Cossak squat', 1, '8/lado', 0),
        _ex('er_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('er_mob_mov_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('er_mob_leg_rock_s5', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('er_pm_res', 'Peso muerto con resistencia', 3, '8-10', 120),
        _ex('er_snatch_mc', 'Snatch con mancuerna', 3, '10/lado', 0),
        _ex('er_gorilla_row', 'Gorilla row', 3, '8/lado', 0),
        _ex('er_pistol_sq_res', 'Pistol squat con resistencia', 2, '8/lado', 0),
        _ex('er_core_russian', 'Core | Russian twist con mancuerna', 2, '8/lado', 0),
        _ex('er_core_kb_pull', 'Core | Kettlebell pull through', 2, '6/lado', 0),
      ],
      6: [
        _ex('er_hiit_burpees_s6', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('er_hiit_sprint_s6', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_jump_plank_s6', 'Core | Jumping jacks plank', 1, '30" trabajo', 30),
        _ex('er_hiit_bench_s6', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('er_sq_bulg_jump_s6', 'Sentadilla búlgara con salto', 1, '30" trabajo', 20),
        _ex('er_hiit_burpees_s6_r2', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('er_hiit_sprint_s6_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_jump_plank_s6_r2', 'Core | Jumping jacks plank', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('er_core_dl_s7', 'Core | Deadlifts', 2, '8/lado', 0),
        _ex('er_est_split_s7', 'Estiramiento | Split unilateral', 2, '30"/lado', 0),
        _ex('er_est_updog_s7', 'Estiramiento | Upward dog', 2, '6', 0),
        _ex('er_est_hombros_s7', 'Estiramiento | Hombros', 2, '15"/lado', 0),
        _ex('er_est_cadera_frog_s7', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
        _ex('er_mob_flex_tib_s7', 'Movilidad | Flexión tibial con resistencia', 2, '10/lado', 0),
        _ex('er_mob_leg_rock_s7', 'Movilidad | Leg Rockback', 2, '8/lado', 0),
        _ex('er_mob_scorp_s7', 'Movilidad | Scorpions', 2, '10/lado', 0),
        _ex('er_mob_flex_tobi_peso_s7', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
    },
    // S2
    {
      1: [
        _ex('er_mob_cat_s2', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('er_mob_snow_s2', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('er_mob_rot_cad_s2', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('er_mob_flex_esc_s2', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('er_sq_goblet_res', 'Sentadilla goblet con peso y resistencia', 3, '8-10', 0),
        _ex('er_caldas_nord', 'Caldas nórdicas con resistencia', 2, '6', 0),
        _ex('er_ht_mc_res', 'Hip thrust con mancuerna y resistencia', 3, '14', 0),
        _ex('er_curtsy_mc', 'Curtsy lunges con mancuerna', 2, '10/lado', 120),
        _ex('er_pm_kb_cad', 'Peso muerto con kettlebell y resistencia en la cadera', 2, '16', 120),
        _ex('er_patada_glut', 'Patada de glúteo con resistencia', 2, '14/lado', 0),
      ],
      2: [
        _ex('er_mob_rot_col_s2', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('er_mob_run_lunge_s2', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('er_mob_cab_s2', 'Movilidad | Shoulder CAB', 1, '10', 0),
        _ex('er_mob_kb_halo_s2', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('er_flex_rodillas', 'Flexiones de rodillas', 4, '6-8', 0),
        _ex('er_jalon_uni_res', 'Jalón unilateral con resistencia', 3, '14/lado', 0),
        _ex('er_elev_front_res', 'Elevaciones frontales con resistencia', 3, '14', 0),
        _ex('er_facepull_s2', 'Facepull con resistencia', 3, '16', 0),
        _ex('er_core_mcgill_s2', 'Core | McGill crunch', 2, '10', 0),
        _ex('er_core_crunch_inv_s2', 'Core | Crunch inverso con disco', 2, '8', 0),
        _ex('er_core_worm_s2', 'Core | Worm walks', 2, '6', 0),
      ],
      3: [
        _ex('er_hiit_plank_thrust', 'HIIT | Plank thrust variation', 1, '30" trabajo', 30),
        _ex('er_hiit_sq_toques', 'HIIT | Sentadilla + toques de pie', 1, '30" trabajo', 30),
        _ex('er_hiit_spider_lunge', 'HIIT | Spider lunges', 1, '30" trabajo', 30),
        _ex('er_hiit_pivot_sq', 'HIIT | Pivot squat jumps 180°', 1, '30" trabajo', 30),
        _ex('er_hiit_sq_rot', 'HIIT | Sentadilla con salto + rotación', 1, '30" trabajo', 30),
        _ex('er_hiit_plank_thrust_r2', 'HIIT | Plank thrust variation', 1, '30" trabajo', 30),
        _ex('er_hiit_sq_toques_r2', 'HIIT | Sentadilla + toques de pie', 1, '30" trabajo', 30),
        _ex('er_hiit_spider_lunge_r2', 'HIIT | Spider lunges', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('er_core_limb_s4', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('er_mob_run_reach', 'Movilidad | Runners lunge with reach', 2, '6/lado', 0),
        _ex('er_est_rodilla_pecho', 'Estiramiento | Rodilla al pecho', 2, '30"/lado', 0),
        _ex('er_est_cadera_frog_s4', 'Estiramiento | Cadera (Frog)', 2, '30"/lado', 0),
        _ex('er_mob_flex_tib_s4', 'Movilidad | Flexión tibial con resistencia', 2, '10/lado', 0),
      ],
      5: [
        _ex('er_mob_cossak_s5', 'Movilidad | Cossak squat', 1, '8/lado', 0),
        _ex('er_mob_bisagra_s5', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('er_mob_mov_esc_s5', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('er_mob_leg_rock_s5b', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('er_pm_res_s5', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('er_sq_kb_remo_ment', 'Sentadilla kettlebell + remo al mentón', 4, '10', 0),
        _ex('er_remo_90_mc', 'Remo a 90 con mancuernas', 3, '8', 0),
        _ex('er_pistol_sq_mc', 'Pistol squat con mancuerna', 2, '6/lado', 0),
        _ex('er_core_crunch_lat', 'Core | Crunch abdominal lateral', 3, '6/lado', 0),
        _ex('er_core_scissors', 'Core | Scissors', 2, '20 en total', 0),
      ],
      6: [
        _ex('er_hiit_fast_feet', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('er_hiit_remo_jump', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
        _ex('er_hiit_lat_lunge', 'HIIT | Lateral lunge drop', 1, '30" trabajo', 30),
        _ex('er_hiit_rocket_sq', 'HIIT | Rocket launch squats', 1, '30" trabajo', 30),
        _ex('er_hiit_skater', 'HIIT | Skater jumps', 1, '30" trabajo', 30),
        _ex('er_hiit_fast_feet_r2', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('er_hiit_remo_jump_r2', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
        _ex('er_hiit_lat_lunge_r2', 'HIIT | Lateral lunge drop', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('er_aduct_copenh', 'Aductores | Plancha Copenhague', 2, '30"/lado', 0),
        _ex('er_est_glut_med', 'Estiramiento | Glúteo medio', 2, '30"/lado', 0),
        _ex('er_est_cuello', 'Estiramiento | Cuello', 2, '30"', 0),
        _ex('er_mob_leg_rock_s7b', 'Movilidad | Leg Rockback', 2, '8/lado', 0),
        _ex('er_mob_scorp_s7b', 'Movilidad | Scorpions', 2, '10/lado', 0),
        _ex('er_mob_flex_tobi_peso_s7b', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
    },
    // S3
    {
      1: [
        _ex('er_mob_cat_s3', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('er_mob_snow_s3', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('er_mob_rot_cad_s3', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('er_mob_flex_esc_s3', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('er_sq_goblet_res_s3', 'Sentadilla goblet con peso y resistencia', 4, '14', 0),
        _ex('er_sq_split_mc', 'Sentadilla Split con mancuernas', 3, '10/lado', 120),
        _ex('er_kb_swing_s3', 'Kettlebell swing', 3, '16', 120),
        _ex('er_patada_glut_s3', 'Patada de glúteo con resistencia', 2, '14/lado', 0),
      ],
      2: [
        _ex('er_mob_rot_col_s3', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('er_mob_run_lunge_s3', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('er_mob_cab_s3', 'Movilidad | Shoulder CAB', 1, '10', 0),
        _ex('er_mob_kb_halo_s3', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('er_flex_rodillas_s3', 'Flexiones de rodillas', 4, '8', 0),
        _ex('er_jalon_uni_res_s3', 'Jalón unilateral con resistencia', 3, '14/lado', 0),
        _ex('er_elev_front_res_s3', 'Elevaciones frontales con resistencia', 3, '14', 0),
        _ex('er_facepull_s3', 'Facepull con resistencia', 3, '16', 0),
        _ex('er_core_cacoon', 'Core | Cacoons', 3, '10', 0),
      ],
      3: [
        _ex('er_hiit_tuck_jump', 'HIIT | Tuck jumps', 1, '30" trabajo', 30),
        _ex('er_hiit_sprint_s3', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_forward_kick', 'Core | Forward kick sits', 1, '30" trabajo', 30),
        _ex('er_hiit_pulse_lunge', 'HIIT | Pulse lunges', 1, '30" trabajo', 30),
        _ex('er_hiit_side_bound', 'HIIT | Side bound launches', 1, '30" trabajo', 30),
        _ex('er_hiit_tuck_jump_r2', 'HIIT | Tuck jumps', 1, '30" trabajo', 30),
        _ex('er_hiit_sprint_s3_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('er_core_forward_kick_r2', 'Core | Forward kick sits', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('er_core_limb_s3', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('er_mob_run_reach_s3', 'Movilidad | Runners lunge with reach', 2, '6/lado', 0),
        _ex('er_est_rodilla_pecho_s3', 'Estiramiento | Rodilla al pecho', 2, '30"/lado', 0),
      ],
      5: [
        _ex('er_mob_cossak_s5b', 'Movilidad | Cossak squat', 1, '8/lado', 0),
        _ex('er_mob_bisagra_s5b', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('er_mob_mov_esc_s5b', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('er_mob_leg_rock_s5c', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('er_pm_res_s5b', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('er_rack_kb_sq', 'Rack kettlebell squat', 4, '8', 0),
        _ex('er_remo_seal_mc', 'Remo seal con mancuernas', 3, '8', 0),
        _ex('er_pistol_sq_walk', 'Pistol squat walks', 2, '6/lado', 0),
        _ex('er_core_crunch_lat_s3', 'Core | Crunch abdominal lateral', 3, '6/lado', 0),
        _ex('er_core_scissors_s3', 'Core | Scissors', 2, '20 en total', 0),
      ],
      6: [
        _ex('er_hiit_calf_jump', 'HIIT | Calf jumps', 1, '30" trabajo', 30),
        _ex('er_core_knee_toe', 'Core | Knee to toe taps', 1, '30" trabajo', 30),
        _ex('er_core_kick_sit', 'Core | Kick sits', 1, '30" trabajo', 30),
        _ex('er_hiit_pulse_sq', 'HIIT | Pulse jump squats', 1, '30" trabajo', 30),
        _ex('er_hiit_prisoner_sq', 'HIIT | Prisoner side to side squats', 1, '30" trabajo', 30),
        _ex('er_hiit_calf_jump_r2', 'HIIT | Calf jumps', 1, '30" trabajo', 30),
        _ex('er_core_knee_toe_r2', 'Core | Knee to toe taps', 1, '30" trabajo', 30),
        _ex('er_core_kick_sit_r2', 'Core | Kick sits', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('er_core_dl_s3', 'Core | Deadlifts', 2, '8/lado', 0),
        _ex('er_est_split_s3', 'Estiramiento | Split unilateral', 2, '30"/lado', 0),
        _ex('er_est_updog_s3', 'Estiramiento | Upward dog', 2, '6', 0),
        _ex('er_est_hombros_s3', 'Estiramiento | Hombros', 2, '15"/lado', 0),
        _ex('er_est_cadera_frog_s3', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
      ],
    },
    // S4
    {
      1: [
        _ex('er_mob_cat_s4', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('er_mob_snow_s4', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('er_mob_rot_cad_s4', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('er_mob_flex_esc_s4', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('er_sq_goblet_res_s4', 'Sentadilla goblet con peso y resistencia', 4, '14', 0),
        _ex('er_sq_split_mc_s4', 'Sentadilla Split con mancuernas', 3, '10/lado', 120),
        _ex('er_kb_swing_s4', 'Kettlebell swing', 3, '16', 120),
        _ex('er_patada_glut_s4', 'Patada de glúteo con resistencia', 2, '14/lado', 0),
      ],
      2: [
        _ex('er_mob_rot_col_s4', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('er_mob_run_lunge_s4', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('er_mob_cab_s4', 'Movilidad | Shoulder CAB', 1, '10', 0),
        _ex('er_mob_kb_halo_s4', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('er_flex_max', 'Flexiones', 1, 'Máximas', 0, 'Instagram record'),
        _ex('er_remo_pie_res', 'Remo de pie con resistencia', 3, '14', 0),
        _ex('er_press_hombro_mc', 'Press de hombro con mancuernas en sedelación', 3, '14', 0),
        _ex('er_facepull_s4', 'Facepull con resistencia', 3, '16', 0),
        _ex('er_core_crunch_s4', 'Core | Crunch', 3, '10', 0),
        _ex('er_core_plank_toques', 'Plancha con toques de hombro', 3, '10/lado', 0),
        _ex('er_core_vups', 'Core | V ups', 3, '8', 0),
      ],
      3: [
        _ex('er_hiit_drop_sq', 'HIIT | Drop squats con disco', 1, '30" trabajo', 30),
        _ex('er_hiit_sq_rodilla', 'HIIT | Sentadilla + toque de rodilla', 1, '30" trabajo', 30),
        _ex('er_core_mt_climber', 'Core | Mountain climbers', 1, '30" trabajo', 30),
        _ex('er_hiit_scissor_jump', 'HIIT | Scissor jumps', 1, '30" trabajo', 30),
        _ex('er_hiit_rocket_tap', 'HIIT | Rocket launch taps', 1, '30" trabajo', 30),
        _ex('er_hiit_drop_sq_r2', 'HIIT | Drop squats con disco', 1, '30" trabajo', 30),
        _ex('er_hiit_sq_rodilla_r2', 'HIIT | Sentadilla + toque de rodilla', 1, '30" trabajo', 30),
        _ex('er_core_mt_climber_r2', 'Core | Mountain climbers', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('er_core_limb_s4', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('er_mob_aduct_maj', 'Movilidad | Aductores (Marjonal)', 2, '30"', 0),
        _ex('er_est_standing_reach', 'Estiramiento | Standing reach-down', 2, '30"', 0),
        _ex('er_est_cadera_pigeon', 'Estiramiento | Cadera (Pigeon)', 2, '30"/lado', 0),
        _ex('er_mob_scorp_s4', 'Movilidad | Scorpions', 2, '8/lado', 0),
        _ex('er_mob_flex_tobi_peso_s4', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
      5: [
        _ex('er_mob_cossak_s4', 'Movilidad | Cossak squat', 1, '8/lado', 0),
        _ex('er_mob_bisagra_s4', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('er_mob_mov_esc_s4', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('er_mob_leg_rock_s4', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('er_pm_res_s4', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('er_sq_kb_remo_ment_s4', 'Sentadilla kettlebell + remo al mentón', 4, '10', 0),
        _ex('er_remo_90_mc_s4', 'Remo a 90 con mancuernas', 2, '4/lado', 0),
        _ex('er_core_pass_through', 'Core | Pass through con mancuernas', 3, '10/lado', 0),
        _ex('er_core_vups_toques', 'Core | V ups con toques de pie', 3, '8', 0),
      ],
      6: [
        _ex('er_hiit_fast_feet_s4', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('er_hiit_remo_jump_s4', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
        _ex('er_hiit_lat_lunge_s4', 'HIIT | Lateral lunge drop', 1, '30" trabajo', 30),
        _ex('er_hiit_rocket_sq_s4', 'HIIT | Rocket launch squats', 1, '30" trabajo', 30),
        _ex('er_hiit_skater_s4', 'HIIT | Skater jumps', 1, '30" trabajo', 30),
        _ex('er_hiit_fast_feet_s4_r2', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('er_hiit_remo_jump_s4_r2', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('er_aduct_copenh_s4', 'Aductores | Plancha Copenhague', 2, '30"/lado', 0),
        _ex('er_est_sitting_reach', 'Estiramiento | Sitting reach', 2, '30"', 0),
        _ex('er_mob_cat_s4b', 'Movilidad | Cat camel', 2, '10', 0),
        _ex('er_est_tricep', 'Estiramiento | Tríceps', 2, '15"/lado', 0),
        _ex('er_est_muñeca', 'Estiramiento | Muñecas', 2, '30"', 0),
        _ex('er_est_standing_reach_s4', 'Estiramiento | Standing reach-down forward', 2, '30"', 0),
      ],
    },
  ]
};
