...
WORKOUT_PLANS.empezando_rutina = {
  ...
  weeklySchedule: [
    ...
    {
      1: [
        _ex('ezc_mob_cat', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('ezc_mob_snow', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('ezc_mob_rot_cad', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('ezc_ht_mc', 'Hip thrust con mancuerna', 3, '14', 0),
        _ex('ezc_sq_split_mc', 'Sentadilla Split con mancuernas', 2, '10/lado', 0),
        _ex('ezc_pull_thru_res', 'Pull through con resistencia', 2, '16', 0),
        _ex('ezc_patada_glut', 'Patada de glúteo con resistencia', 1, '14/lado', 0),
      ],
      2: [
        _ex('ezc_mob_rot_col', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('ezc_mob_run_lunge', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('ezc_mob_car', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('ezc_mob_kb_halo', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('ezc_flex_elev', 'Flexiones con elevación', 3, '8-10', 0),
        _ex('ezc_remo_pie_res', 'Remo de pie con resistencia', 3, '10', 0),
        _ex('ezc_elev_lat_res', 'Elevaciones laterales con resistencia', 1, '10', 30, 'rest x3'),
        _ex('ezc_facepull_res', 'Facepull con resistencia', 3, '16', 0),
        _ex('ezc_core_zombie', 'Core | Zombie sit ups', 2, '8', 0),
        _ex('ezc_core_elev_iso', 'Core | Elevación de piernas isométrica', 2, '30"', 0),
        _ex('ezc_core_wheel', 'Core | Rueda abdominal adaptada', 2, '8', 0),
      ],
      3: [
        _ex('ezc_mob_rot_cad_s1d3', 'Movilidad | Rotación de cadera 90-90', 1, '8/lado', 0),
        _ex('ezc_mob_squat_cob', 'Movilidad | Squat cobalt', 1, '10/lado', 0),
        _ex('ezc_mob_rot_int', 'Movilidad | 90/90 rotación interna', 1, '8/lado', 0),
        _ex('ezc_sq_goblet_res', 'Sentadilla goblet con peso y resistencia', 3, '8-10', 0),
        _ex('ezc_caldas_nord_res', 'Caídas nórdicas inversas con resistencia', 2, '6', 0),
        _ex('ezc_ht_mc_s1d3', 'Hip thrust con mancuerna', 3, '14', 0),
        _ex('ezc_curtsy_mc', 'Curtsy lunges con mancuerna', 2, '10/lado', 0),
        _ex('ezc_pm_kb_cad', 'Peso muerto con kettlebell y resistencia en la cadera', 2, '16', 0),
        _ex('ezc_patada_glut_s1d3', 'Patada de glúteo con resistencia', 1, '14/lado', 0),
      ],
      4: [
        _ex('ezc_core_deadbug', 'Core | Deadbugs', 2, '8/lado', 0),
        _ex('ezc_est_pir', 'Estiramiento | Piramidal', 2, '30"/lado', 0),
        _ex('ezc_mob_flex_esc', 'Movilidad | Flexiones escapulares', 2, '10', 0),
      ],
      5: [
        _ex('ezc_mob_cosak', 'Movilidad | Cosak squat', 1, '8/lado', 0),
        _ex('ezc_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('ezc_mob_mov_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('ezc_mob_leg_rock', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('ezc_pm_res', 'Peso muerto con resistencia', 3, '8-10', 0),
        _ex('ezc_snatch_mc', 'Snatch con mancuerna', 3, '10/lado', 0),
      ],
      6: [
        _ex('ezc_hiit_burp', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_jump_plank', 'Core | Jumping Jacks plank', 1, '30" trabajo', 30),
        _ex('ezc_hiit_bench_jump', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('ezc_sq_bulg_jump', 'Sentadilla búlgara con salto', 1, '30" trabajo', 30),
        _ex('ezc_hiit_burp_r2', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_jump_plank_r2', 'Core | Jumping Jacks plank', 1, '30" trabajo', 30),
        _ex('ezc_hiit_bench_jump_r2', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('ezc_sq_bulg_jump_r2', 'Sentadilla búlgara con salto', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('ezc_core_deadbug_s1d7', 'Core | Deadbugs', 2, '8/lado', 0),
        _ex('ezc_est_split', 'Estiramiento | Split unilateral', 2, '30"/lado', 0),
        _ex('ezc_mob_aduct_kb', 'Movilidad | Aductores con kettlebell', 2, '8/lado', 0),
        _ex('ezc_mob_rot_col_s1d7', 'Movilidad | Rotación de columna en T', 2, '10/lado', 0),
        _ex('ezc_mob_deep_squat', 'Movilidad | Deep squat prayer opener', 2, '30"', 0),
      ],
    },
    // S2
    {
      1: [
        _ex('ezc_mob_cat_s2', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('ezc_mob_snow_s2', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('ezc_mob_rot_cad_s2', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('ezc_mob_flex_esc_s2', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('ezc_sq_goblet_res_s2', 'Sentadilla goblet con peso y resistencia', 3, '8-10', 0),
        _ex('ezc_caldas_nord_res_s2', 'Caídas nórdicas inversas con resistencia', 2, '6', 0),
        _ex('ezc_ht_mc_s2', 'Hip thrust con mancuerna', 3, '14', 0),
        _ex('ezc_curtsy_mc_s2', 'Curtsy lunges con mancuerna', 2, '10/lado', 120),
        _ex('ezc_pm_kb_cad_s2', 'Peso muerto con kettlebell y resistencia en la cadera', 2, '16', 120),
        _ex('ezc_patada_glut_s2', 'Patada de glúteo con resistencia', 1, '14/lado', 0),
      ],
      2: [
        _ex('ezc_mob_rot_col_s2', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('ezc_mob_run_lunge_s2', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('ezc_mob_car_s2', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('ezc_mob_kb_halo_s2', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('ezc_flex_rodillas', 'Flexiones de rodillas', 4, '6-8', 0),
        _ex('ezc_jalon_uni_res', 'Jalón unilateral con resistencia', 3, '14/lado', 0),
        _ex('ezc_prensa_pecho_res', 'Prensa de pecho con resistencia tumbada', 3, '20', 0),
        _ex('ezc_facepull_res_s2', 'Facepull con resistencia', 3, '16', 0),
        _ex('ezc_core_mcgill', 'Core | McGill crunch', 2, '10', 0),
        _ex('ezc_core_mcgill_r2', 'Core | McGill crunch', 2, '10', 0),
        _ex('ezc_core_crunch_inv', 'Core | Crunch inverso con disco', 2, '8', 0),
        _ex('ezc_core_worm', 'Core | Worm walks', 2, '6', 0),
      ],
      3: [
        _ex('ezc_hiit_plank_thrust', 'HIIT | Plank thrust variation', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_toques', 'HIIT | Sentadilla + toques de pie', 1, '30" trabajo', 30),
        _ex('ezc_hiit_spider', 'HIIT | Spider lunges', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pivot_sq', 'HIIT | Pivot squat jumps 180°', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_rot', 'HIIT | Sentadilla con salto + rotación', 1, '30" trabajo', 30),
        _ex('ezc_hiit_plank_thrust_r2', 'HIIT | Plank thrust variation', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_toques_r2', 'HIIT | Sentadilla + toques de pie', 1, '30" trabajo', 30),
        _ex('ezc_hiit_spider_r2', 'HIIT | Spider lunges', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pivot_sq_r2', 'HIIT | Pivot squat jumps 180°', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_rot_r2', 'HIIT | Sentadilla con salto + rotación', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('ezc_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('ezc_est_pir_sed', 'Estiramiento | Piramidal sentada', 2, '30"/lado', 0),
        _ex('ezc_est_espalda', 'Estiramiento | Espaldín en cajón', 2, '30"', 0),
        _ex('ezc_est_cadera_frog', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
        _ex('ezc_est_hombros_rot', 'Estiramiento | Hombros con rotación', 2, '15"', 0),
        _ex('ezc_mob_flex_tib', 'Movilidad | Flexión tibial con consistencia', 2, '10/lado', 0),
      ],
      5: [
        _ex('ezc_mob_cosak_s2', 'Movilidad | Cosak squat', 1, '8/lado', 0),
        _ex('ezc_mob_bisagra_s2', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('ezc_mob_mov_esc_s2', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('ezc_mob_leg_rock_s2', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('ezc_pm_res_s2', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('ezc_sq_kb_remo', 'Sentadilla kettlebell + remo al mentón', 4, '10', 0),
        _ex('ezc_rack_kb_sq', 'Rack kettlebell squat', 4, '8/lado', 0),
      ],
      6: [
        _ex('ezc_hiit_burp_s2', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint_s2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_jump_plank_s2', 'Core | Jumping Jacks plank', 1, '30" trabajo', 30),
        _ex('ezc_hiit_bench_jump_s2', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('ezc_sq_bulg_jump_s2', 'Sentadilla búlgara con salto', 1, '30" trabajo', 30),
        _ex('ezc_hiit_burp_s2_r2', 'HIIT | Burpees', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint_s2_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_jump_plank_s2_r2', 'Core | Jumping Jacks plank', 1, '30" trabajo', 30),
        _ex('ezc_hiit_bench_jump_s2_r2', 'HIIT | Bench over jumps', 1, '30" trabajo', 30),
        _ex('ezc_sq_bulg_jump_s2_r2', 'Sentadilla búlgara con salto', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('ezc_aduct_copenh', 'Aductores | Plancha Copenhague', 2, '30"/lado', 0),
        _ex('ezc_est_glut_med', 'Estiramiento | Glúteo medio', 2, '30"/lado', 0),
        _ex('ezc_est_cuello', 'Estiramiento | Cuello', 2, '30"', 0),
        _ex('ezc_mob_leg_rock_s2d7', 'Movilidad | Leg Rockback', 2, '8/lado', 0),
        _ex('ezc_mob_scorp', 'Movilidad | Scorpions', 2, '10/lado', 0),
        _ex('ezc_mob_flex_tobi_peso', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
    },
    // S3
    {
      1: [
        _ex('ezc_mob_cat_s3', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('ezc_mob_snow_s3', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('ezc_mob_rot_cad_s3', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('ezc_mob_flex_esc_s3', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('ezc_sq_goblet_res_s3', 'Sentadilla goblet con peso y resistencia', 4, '8-10', 0),
        _ex('ezc_curl_fem_res', 'Curl de fémur con resistencia', 2, '14', 0),
        _ex('ezc_ht_mc_res_s3', 'Hip thrust con mancuerna y resistencia', 4, '14', 0),
        _ex('ezc_sq_split_mc_s3', 'Sentadilla Split con mancuernas', 3, '10/lado', 120),
        _ex('ezc_kb_swing', 'Kettlebell swing', 3, '16', 120),
        _ex('ezc_patada_glut_s3', 'Patada de glúteo con resistencia', 1, '14/lado', 0),
      ],
      2: [
        _ex('ezc_mob_rot_col_s3', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('ezc_mob_run_lunge_s3', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('ezc_mob_car_s3', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('ezc_mob_kb_halo_s3', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('ezc_flex_rodillas_s3', 'Flexiones de rodillas', 4, '8', 0),
        _ex('ezc_jalon_uni_res_s3', 'Jalón unilateral con resistencia', 3, '14/lado', 0),
        _ex('ezc_prensa_pecho_res_s3', 'Prensa de pecho con resistencia tumbada', 3, '20', 0),
        _ex('ezc_facepull_res_s3', 'Facepull con resistencia', 3, '16', 0),
        _ex('ezc_core_cacoon', 'Core | Cacoons', 3, '10', 0),
        _ex('ezc_core_cacoon_r2', 'Core | Cacoons', 3, '10', 0),
        _ex('ezc_core_plank_inv', 'Core | Plancha inversa con toques de rodilla', 3, '30"', 0),
        _ex('ezc_core_vups_toques', 'Core | V-ups con toques de pie', 3, '8', 0),
      ],
      3: [
        _ex('ezc_hiit_tuck', 'HIIT | Tuck jumps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint_s3', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_forward_kick', 'Core | Forward kick sits', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pulse_lunge', 'HIIT | Pulse lunges', 1, '30" trabajo', 30),
        _ex('ezc_hiit_side_bound', 'HIIT | Side-bound launches', 1, '30" trabajo', 30),
        _ex('ezc_hiit_tuck_r2', 'HIIT | Tuck jumps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sprint_s3_r2', 'HIIT | Sprints con resistencia', 1, '30" trabajo', 30),
        _ex('ezc_core_forward_kick_r2', 'Core | Forward kick sits', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pulse_lunge_r2', 'HIIT | Pulse lunges', 1, '30" trabajo', 30),
        _ex('ezc_hiit_side_bound_r2', 'HIIT | Side-bound launches', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('ezc_core_limb_s3', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('ezc_mob_run_reach', 'Movilidad | Runners lunge with reach', 2, '6/lado', 0),
        _ex('ezc_est_rodilla_pecho', 'Estiramiento | Rodilla al pecho', 2, '30"/lado', 0),
      ],
      5: [
        _ex('ezc_mob_cosak_s3', 'Movilidad | Cosak squat', 1, '8/lado', 0),
        _ex('ezc_mob_bisagra_s3', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('ezc_mob_mov_esc_s3', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('ezc_mob_leg_rock_s3', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('ezc_pm_res_s3', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('ezc_rack_kb_sq_s3', 'Rack kettlebell squat', 4, '8', 0),
        _ex('ezc_remo_seal_mc', 'Remo seal con mancuernas', 3, '8', 0),
        _ex('ezc_pistol_sq_walk', 'Pistol squat walks', 2, '6/lado', 0),
        _ex('ezc_core_crunch_lat', 'Core | Crunch abdominal lateral', 3, '6/lado', 0),
      ],
      6: [
        _ex('ezc_hiit_calf', 'HIIT | Calf jumps', 1, '30" trabajo', 30),
        _ex('ezc_core_knee_toe', 'Core | Knee to toe taps', 1, '30" trabajo', 30),
        _ex('ezc_core_kick_sit', 'Core | Kick sits', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pulse_sq', 'HIIT | Pulse jump squats', 1, '30" trabajo', 30),
        _ex('ezc_hiit_prisoner_sq', 'HIIT | Prisoner side to side squats', 1, '30" trabajo', 30),
        _ex('ezc_hiit_calf_r2', 'HIIT | Calf jumps', 1, '30" trabajo', 30),
        _ex('ezc_core_knee_toe_r2', 'Core | Knee to toe taps', 1, '30" trabajo', 30),
        _ex('ezc_core_kick_sit_r2', 'Core | Kick sits', 1, '30" trabajo', 30),
        _ex('ezc_hiit_pulse_sq_r2', 'HIIT | Pulse jump squats', 1, '30" trabajo', 30),
        _ex('ezc_hiit_prisoner_sq_r2', 'HIIT | Prisoner side to side squats', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('ezc_core_deadbug_s3d7', 'Core | Deadbugs', 2, '8/lado', 0),
        _ex('ezc_est_split_s3', 'Estiramiento | Split unilateral', 2, '30"/lado', 0),
        _ex('ezc_est_updog', 'Estiramiento | Upward dog', 2, '6', 0),
        _ex('ezc_est_hombros', 'Estiramiento | Hombros', 2, '15"/lado', 0),
        _ex('ezc_est_cadera_frog_s3', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
        _ex('ezc_mob_flex_tib_s3', 'Movilidad | Flexión tibial con consistencia', 2, '10/lado', 0),
      ],
    },
    // S4
    {
      1: [
        _ex('ezc_mob_cat_s4', 'Movilidad | Cat camel', 1, '10', 0),
        _ex('ezc_mob_snow_s4', 'Movilidad | Prone snow angels', 1, '10', 0),
        _ex('ezc_mob_rot_cad_s4', 'Movilidad | Rotación interna de cadera 90-90', 1, '8/lado', 0),
        _ex('ezc_mob_flex_esc_s4', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('ezc_sq_goblet_res_s4', 'Sentadilla goblet con peso y resistencia', 4, '8-10', 0),
        _ex('ezc_caldas_nord_s4', 'Caídas nórdicas con resistencia', 2, '6', 0),
        _ex('ezc_ht_mc_res_s4', 'Hip thrust con mancuerna y resistencia', 4, '14', 0),
        _ex('ezc_sq_split_mc_s4', 'Sentadilla Split con mancuernas', 3, '10/lado', 0),
        _ex('ezc_kb_clean_press', 'Kettlebell clean and press', 3, '10/lado', 0),
        _ex('ezc_patada_glut_s4', 'Patada de glúteo con resistencia', 1, '14/lado', 0),
      ],
      2: [
        _ex('ezc_mob_rot_col_s4', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('ezc_mob_run_lunge_s4', 'Movilidad | Runners lunge', 1, '7/lado', 0),
        _ex('ezc_mob_car_s4', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('ezc_mob_kb_halo_s4', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('ezc_flex_max', 'Flexiones', 1, 'Máximas', 0, 'Instagram record'),
        _ex('ezc_remo_pie_res_s4', 'Remo de pie con resistencia', 3, '14', 0),
        _ex('ezc_press_hombro_mc_sed', 'Prensa de hombro con mancuernas en sedestación', 3, '14', 0),
        _ex('ezc_facepull_res_s4', 'Facepull con resistencia', 3, '16', 0),
        _ex('ezc_core_crunch_s4', 'Core | Crunch', 3, '10', 0),
        _ex('ezc_core_crunch_s4_r2', 'Core | Crunch', 3, '10', 0),
        _ex('ezc_core_plank_toques', 'Plancha con toques de hombro', 3, '10/lado', 0),
        _ex('ezc_core_vups', 'Core | V-ups', 3, '8', 0),
      ],
      3: [
        _ex('ezc_hiit_drop_sq', 'HIIT | Drop squats con disco', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_rodilla', 'HIIT | Sentadilla + toque de rodilla', 1, '30" trabajo', 30),
        _ex('ezc_core_mt_climber', 'Core | Mountain climbers', 1, '30" trabajo', 30),
        _ex('ezc_hiit_scissor', 'HIIT | Scissor jumps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_rocket_tap', 'HIIT | Rocket launch taps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_drop_sq_r2', 'HIIT | Drop squats con disco', 1, '30" trabajo', 30),
        _ex('ezc_hiit_sq_rodilla_r2', 'HIIT | Sentadilla + toque de rodilla', 1, '30" trabajo', 30),
        _ex('ezc_core_mt_climber_r2', 'Core | Mountain climbers', 1, '30" trabajo', 30),
        _ex('ezc_hiit_scissor_r2', 'HIIT | Scissor jumps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_rocket_tap_r2', 'HIIT | Rocket launch taps', 1, '30" trabajo', 30),
      ],
      4: [
        _ex('ezc_core_limb_s4', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('ezc_est_aduct', 'Estiramiento | Aductores (Marjones)', 2, '30"', 0),
        _ex('ezc_est_standing_reach', 'Estiramiento | Standing reach down', 2, '30"', 0),
        _ex('ezc_est_cadera_frog_s4', 'Estiramiento | Cadera (Frog)', 2, '30"/lado', 0),
        _ex('ezc_mob_scorp_s4', 'Movilidad | Scorpions', 2, '8/lado', 0),
        _ex('ezc_mob_flex_tobi_peso_s4', 'Movilidad | Flexión de tobillo con peso', 2, '30"/lado', 0),
      ],
      5: [
        _ex('ezc_mob_cosak_s4', 'Movilidad | Cosak squat', 1, '8/lado', 0),
        _ex('ezc_mob_bisagra_s4', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('ezc_mob_mov_esc_s4', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('ezc_mob_leg_rock_s4', 'Movilidad | Leg Rockback', 1, '8 rebotes/lado', 0),
        _ex('ezc_pm_res_s4', 'Peso muerto con resistencia', 4, '8-10', 0),
        _ex('ezc_sq_kb_remo_s4', 'Sentadilla kettlebell + remo al mentón', 4, '10', 0),
        _ex('ezc_core_pass_through', 'Core | Pass through con mancuernas', 3, '10/lado', 0),
      ],
      6: [
        _ex('ezc_hiit_fast_feet', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('ezc_hiit_remo_jump', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
        _ex('ezc_hiit_lat_lunge', 'HIIT | Lateral lunge drop', 1, '30" trabajo', 30),
        _ex('ezc_hiit_rocket_sq', 'HIIT | Rocket launch squats', 1, '30" trabajo', 30),
        _ex('ezc_hiit_skater', 'HIIT | Skater jumps', 1, '30" trabajo', 30),
        _ex('ezc_hiit_fast_feet_r2', 'HIIT | Fast feet', 1, '30" trabajo', 30),
        _ex('ezc_hiit_remo_jump_r2', 'HIIT | Remo con salto y resistencia', 1, '30" trabajo', 30),
        _ex('ezc_hiit_lat_lunge_r2', 'HIIT | Lateral lunge drop', 1, '30" trabajo', 30),
        _ex('ezc_hiit_rocket_sq_r2', 'HIIT | Rocket launch squats', 1, '30" trabajo', 30),
        _ex('ezc_hiit_skater_r2', 'HIIT | Skater jumps', 1, '30" trabajo', 30),
      ],
      7: [
        _ex('ezc_aduct_copenh_s4', 'Aductores | Plancha Copenhague', 2, '30"/lado', 0),
        _ex('ezc_est_sitting_reach', 'Estiramiento | Sitting reach', 2, '30"', 0),
        _ex('ezc_mob_cat_s4d7', 'Movilidad | Cat camel', 2, '10', 0),
        _ex('ezc_est_tricep', 'Estiramiento | Triceps', 2, '15"/lado', 0),
        _ex('ezc_est_muñeca', 'Estiramiento | Muñecas', 2, '30"', 0),
        _ex('ezc_est_standing_reach_fwd', 'Estiramiento | Standing reach down forward', 2, '30"', 0),
      ],
    },
  ]
};
