...
WORKOUT_PLANS.empezando_rutina = {
  ...
  weeklySchedule: [
    ...
    // S2
    {
      ...
      3: [
        _ex('ezc_s2d3_plank_thrust', 'HIIT | Plank thrust variation', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d3_sq_toques', 'HIIT | Sentadilla + toques de pie', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d3_spider', 'HIIT | Spider lunges', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d3_pivot_sq', 'HIIT | Pivot squat jumps 180°', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d3_sq_rot', 'HIIT | Sentadilla con salto + rotación', 3, '30" trabajo', 30, '3 rondas'),
      ],
      4: [
      ...
      6: [
        _ex('ezc_s2d6_burp', 'HIIT | Burpees', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d6_sprint', 'HIIT | Sprints con resistencia', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d6_jump_plank', 'Core | Jumping jacks plank', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d6_bench_jump', 'HIIT | Bench over jumps', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s2d6_bulg_jump', 'Sentadilla búlgara con salto', 3, '30" trabajo', 30, '3 rondas'),
      ],
      7: [
    ...
    // S3
    {
      ...
      3: [
        _ex('ezc_s3d3_tuck', 'HIIT | Tuck jumps', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d3_sprint', 'HIIT | Sprints con resistencia', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d3_forward_kick', 'Core | Forward kick sits', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d3_pulse_lunge', 'Pulse lunges', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d3_side_bound', 'HIIT | Side bound launches', 3, '30" trabajo', 30, '3 rondas'),
      ],
      4: [
      ...
      6: [
        _ex('ezc_s3d6_calf', 'HIIT | Calf jumps', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d6_knee_toe', 'Core | Knee to toe taps', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d6_kick_sit', 'Core | Kick sits', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d6_pulse_sq', 'HIIT | Pulse jump squats', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s3d6_prisoner', 'HIIT | Prisoner side to side squats', 3, '30" trabajo', 30, '3 rondas'),
      ],
      7: [
    ...
    // S4
    {
      ...
      3: [
        _ex('ezc_s4d3_drop_sq', 'HIIT | Drop squats con disco', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d3_sq_rodilla', 'HIIT | Sentadilla + toque de rodilla', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d3_mt_climber', 'Core | Mountain climbers', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d3_scissor', 'HIIT | Scissor jumps', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d3_rocket_tap', 'HIIT | Rocket launch taps', 3, '30" trabajo', 30, '3 rondas'),
      ],
      4: [
      ...
      6: [
        _ex('ezc_s4d6_fast_feet', 'HIIT | Fast feet', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d6_remo_jump', 'HIIT | Remo con salto y resistencia', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d6_lat_lunge', 'HIIT | Lateral lunge drop', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d6_rocket_sq', 'Rocket launch squats', 3, '30" trabajo', 30, '3 rondas'),
        _ex('ezc_s4d6_skater', 'HIIT | Skater jumps', 3, '30" trabajo', 30, '3 rondas'),
      ],
      7: [
