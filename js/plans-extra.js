...
WORKOUT_PLANS.empezando_gym = {
  ...
  planType: 'phased',
  weeks: 4,
  description: 'Plan de 4 semanas en el gym — desde cero, movilidad + fuerza + HIIT',
  trainingDays: [1, 2, 3, 4, 5, 6, 7],
  dayMeta: {
    1: { name: 'Fuerza Bajo Cuerpo',   type: 'strength', muscleGroups: ['Piernas', 'Glúteos'] },
    2: { name: 'Movilidad + Fuerza',   type: 'strength', muscleGroups: ['Pecho', 'Espalda'] },
    3: { name: 'HIIT',                 type: 'strength', muscleGroups: ['Full body', 'Cardio'] },
    4: { name: 'Movilidad + Core',     type: 'strength', muscleGroups: ['Core', 'Flexibilidad'] },
    5: { name: 'Fuerza Completa',      type: 'strength', muscleGroups: ['Full body'] },
    6: { name: 'HIIT',                 type: 'strength', muscleGroups: ['Full body', 'Cardio'] },
    7: { name: 'Movilidad Completa',   type: 'strength', muscleGroups: ['Flexibilidad', 'Recuperación'] }
  },
  weeklySchedule: [
    // SEMANA 1
    {
      1: [
        _ex('eg_s1d1_mob_logback', 'Movilidad | Log Backback', 1, '8 rebotes/lado', 0),
        _ex('eg_s1d1_peso_inv', 'Peso invertido (barra)', 2, '8', 0),
        _ex('eg_s1d1_pm_conv', 'Peso muerto convencional', 2, '10', 0),
        _ex('eg_s1d1_thruster_mc', 'Thruster con mancuernas', 3, '10', 0),
      ],
      2: [
        _ex('eg_s1d2_mob_rot_col', 'Movilidad | Rotación de columna en T', 1, '8/lado', 0),
        _ex('eg_s1d2_mob_flex_esc', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('eg_s1d2_sent_libre', 'Sentadilla libre barra alta', 2, '10', 0),
        _ex('eg_s1d2_caldas_nord', 'Caldas nórdicas con resistencia', 2, '6', 0),
      ],
      3: [
        _ex('eg_s1d3_hiit_1', 'HIIT | Saltos de caja', 1, '30"', 30),
        _ex('eg_s1d3_hiit_2', 'HIIT | Sentadillas', 1, '30"', 30),
        _ex('eg_s1d3_hiit_3', 'HIIT | Burpees', 1, '30"', 30),
        _ex('eg_s1d3_hiit_4', 'HIIT | Mountain climbers', 1, '30"', 30),
        _ex('eg_s1d3_hiit_5', 'HIIT | Jumping jacks', 1, '30"', 30),
      ],
      4: [
        _ex('eg_s1d4_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('eg_s1d4_est_pir', 'Estiramiento | Piramidal sentada', 2, '30"', 0),
        _ex('eg_s1d4_est_espalda', 'Estiramiento | Espalda en cajón', 2, '30"', 0),
        _ex('eg_s1d4_est_cadera', 'Estiramiento | Cadera (Frog)', 2, '30"', 0),
        _ex('eg_s1d4_est_hombros', 'Estiramiento | Hombros con rotación', 2, '15"/lado', 0),
        _ex('eg_s1d4_mob_flex_tib', 'Movilidad | Flexión tibial', 1, '10/lado', 0),
      ],
      5: [
        _ex('eg_s1d5_mob_cossack', 'Movilidad | Cossack squat', 1, '8/lado', 0),
        _ex('eg_s1d5_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('eg_s1d5_mob_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('eg_s1d5_mob_logback', 'Movilidad | Log Backback', 1, '8/lado', 0),
        _ex('eg_s1d5_pm_1', 'Peso muerto convencional', 2, '8', 0),
        _ex('eg_s1d5_pm_2', 'Peso muerto convencional', 2, '10', 0),
        _ex('eg_s1d5_thruster', 'Thruster con mancuernas', 3, '10', 0),
        _ex('eg_s1d5_pullups', 'Australian pull-ups', 3, '6', 0),
        _ex('eg_s1d5_pistol', 'Pistol squat con resistencia', 2, '8/lado', 0),
        _ex('eg_s1d5_core_russian', 'Core | Russian twist', 2, '30"', 30),
      ],
      6: [
        _ex('eg_s1d6_mob_logback', 'Movilidad | Log Backback', 1, '8/lado', 0),
        _ex('eg_s1d6_pullups', 'Australian pull-ups', 3, '6', 0),
        _ex('eg_s1d6_pistol_unilateral', 'Squat unilateral (pistol)', 2, '10/lado', 0),
        _ex('eg_s1d6_core_plank', 'Core | Plancha codos a manos', 2, '10', 0),
        _ex('eg_s1d6_pistol_2', 'Squat unilateral (pistol)', 2, '10/lado', 0),
        _ex('eg_s1d6_core_press', 'Core | Press Palof', 2, '8/lado', 0),
      ],
      7: [
        _ex('eg_s1d7_core_deadhugs', 'Core | Deadhugs', 2, '8/lado', 0),
        _ex('eg_s1d7_est_pir', 'Estiramiento | Piramidal', 2, '30"/lado', 0),
        _ex('eg_s1d7_mob_flex_esc', 'Movilidad | Flexiones escapulares', 2, '10', 0),
    ...
    // SEMANA 2
    {
      1: [
        ...
        _ex('eg_s2d1_mob_rot90', 'Movilidad | Rotación interna cadera 90-90', 1, '8/lado', 0),
        _ex('eg_s2d1_mob_flex_esc', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('eg_s2d1_sent_1', 'Sentadilla libre barra alta', 2, '10', 0),
        _ex('eg_s2d1_sent_2', 'Sentadilla libre barra alta', 1, '8', 0),
        _ex('eg_s2d1_caldas', 'Caldas nórdicas con resistencia', 2, '6', 0),
      ],
      2: [
        ...
        _ex('eg_s2d2_mob_shoulder_car', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('eg_s2d2_mob_kb_halos', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('eg_s2d2_flexiones_plyo', 'Flexiones plométricas con altura', 3, '6-8', 0),
        _ex('eg_s2d2_remo_gironda', 'Remo gironda en polea', 3, '14', 0),
      ],
      3: [
        _ex('eg_s2d3_hiit_1', 'HIIT | Plank thrust variation', 1, '30"', 30),
        _ex('eg_s2d3_hiit_2', 'HIIT | Sentadilla + toques pie', 1, '30"', 30),
        _ex('eg_s2d3_hiit_3', 'HIIT | Spider lunges', 1, '30"', 30),
        _ex('eg_s2d3_hiit_4', 'HIIT | Pivot squat jumps 180°', 1, '30"', 30),
        _ex('eg_s2d3_hiit_5', 'HIIT | Sentadilla + salto rotación', 1, '30"', 30),
      ],
      4: [
        _ex('eg_s2d4_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('eg_s2d4_est_aduct', 'Estiramiento | Aductores (Mariposa)', 2, '30"', 0),
        _ex('eg_s2d4_est_standing', 'Estiramiento | Standing reach down', 2, '30"', 0),
      ],
      5: [
        _ex('eg_s2d5_mob_cossack', 'Movilidad | Cossack squat', 1, '8/lado', 0),
        _ex('eg_s2d5_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('eg_s2d5_mob_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('eg_s2d5_mob_logback', 'Movilidad | Log Backback', 1, '8/lado', 0),
        _ex('eg_s2d5_pm_1', 'Peso muerto convencional', 2, '8', 0),
        _ex('eg_s2d5_pm_2', 'Peso muerto convencional', 2, '10', 0),
        _ex('eg_s2d5_kb_squat', 'Back kettlebell squat', 4, '8', 0),
        _ex('eg_s2d5_dominadas_neg', 'Dominadas negativas', 3, '8', 0),
        _ex('eg_s2d5_pistol_walks', 'Pistol squat walks', 2, '6/lado', 0),
        _ex('eg_s2d5_core_crunch_lat', 'Core | Crunch abdominal lateral', 3, '6/lado', 30),
      ],
      6: [
        _ex('eg_s2d6_hiit_1', 'HIIT | Burpees', 1, '30"', 30),
        _ex('eg_s2d6_hiit_2', 'HIIT | Sprints con resistencia', 1, '30"', 30),
        _ex('eg_s2d6_hiit_3', 'HIIT | Jumping jacks plank', 1, '30"', 30),
        _ex('eg_s2d6_hiit_4', 'HIIT | Bench over jumps', 1, '30"', 30),
        _ex('eg_s2d6_hiit_5', 'HIIT | Sentadilla búlgara con salto', 1, '30"', 30),
      ],
      7: [
        ...
        _ex('eg_s2d7_mob_logback', 'Movilidad | Log Backback', 2, '8/pierna', 0),
        _ex('eg_s2d7_mob_scorpions', 'Movilidad | Scorpions', 2, '10/lado', 0),
        _ex('eg_s2d7_mob_flex_tobillo', 'Movilidad | Flexión tobillo con peso', 2, '30"/lado', 0),
      ],
    },
    // SEMANA 3
    {
      1: [
        ...
        _ex('eg_s3d1_mob_rlunge_reach', 'Movilidad | Runners lunge with reach', 2, '6/lado', 0),
        _ex('eg_s3d1_est_rodilla_pecho', 'Estiramiento | Rodilla al pecho', 2, '30"/lado', 0),
        _ex('eg_s3d1_mob_bridge_march', 'Movilidad | Bridge march', 2, '8/lado', 0),
      ...
      2: [
        ...
        _ex('eg_s3d2_mob_shoulder_car', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('eg_s3d2_mob_kb_halos', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('eg_s3d2_flexiones', 'Flexiones con resistencia', 4, '8', 0),
        _ex('eg_s3d2_jalon_unilateral', 'Jalón unilateral en polea', 3, '14', 0),
        _ex('eg_s3d2_elev_frontales', 'Elevaciones frontales con mancuernas', 3, '14', 0),
        _ex('eg_s3d2_core_coccoons', 'Core | Coccoons', 3, '30"', 30),
      ],
      3: [
        _ex('eg_s3d3_hiit_1', 'HIIT | Tuck jumps', 1, '30"', 30),
        _ex('eg_s3d3_hiit_2', 'HIIT | Sprints con resistencia', 1, '30"', 30),
        _ex('eg_s3d3_hiit_3', 'HIIT | Forward kick sits', 1, '30"', 30),
        _ex('eg_s3d3_hiit_4', 'HIIT | Pulse lunges', 1, '30"', 30),
        _ex('eg_s3d3_hiit_5', 'HIIT | Side-bound launches', 1, '30"', 30),
      ],
      4: [
        _ex('eg_s3d4_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('eg_s3d4_mob_rlunge_reach', 'Movilidad | Runners lunge with reach', 2, '6/lado', 0),
        _ex('eg_s3d4_est_rodilla_pecho', 'Estiramiento | Rodilla al pecho', 2, '30"/lado', 0),
        _ex('eg_s3d4_mob_bridge_march', 'Movilidad | Bridge march', 2, '8/lado', 0),
        _ex('eg_s3d4_mob_supermans', 'Movilidad | Supermans', 2, '10', 0),
        _ex('eg_s3d4_est_circular', 'Estiramientos circulares', 2, '8/lado', 0),
      ],
      5: [
        _ex('eg_s3d5_mob_cossack', 'Movilidad | Cossack squat', 1, '8/lado', 0),
        _ex('eg_s3d5_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('eg_s3d5_mob_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('eg_s3d5_mob_logback', 'Movilidad | Log Backback', 1, '8/lado', 0),
        _ex('eg_s3d5_pm_1', 'Peso muerto convencional', 2, '8', 0),
        _ex('eg_s3d5_pm_2', 'Peso muerto convencional', 2, '10', 0),
        _ex('eg_s3d5_kb_squat', 'Back kettlebell squat', 4, '8', 0),
        _ex('eg_s3d5_dominadas_neg', 'Dominadas negativas', 3, '8', 0),
        _ex('eg_s3d5_pistol_walks', 'Pistol squat walks', 2, '6/lado', 0),
        _ex('eg_s3d5_core_crunch_lat', 'Core | Crunch abdominal lateral', 3, '6/lado', 30),
      ],
      6: [
        _ex('eg_s3d6_hiit_1', 'HIIT | Calf jumps', 1, '30"', 30),
        _ex('eg_s3d6_hiit_2', 'HIIT | Knee to toe taps', 1, '30"', 30),
        _ex('eg_s3d6_hiit_3', 'HIIT | Kick sits', 1, '30"', 30),
        _ex('eg_s3d6_hiit_4', 'HIIT | Pulse jump squats', 1, '30"', 30),
        _ex('eg_s3d6_hiit_5', 'HIIT | Prisoner side to side squats', 1, '30"', 30),
      ],
      7: [
        _ex('eg_s3d7_core_deadhugs', 'Core | Deadhugs', 2, '8/lado', 0),
    ...
    // SEMANA 4
    {
      1: [
        ...
        _ex('eg_s4d1_mob_rot90', 'Movilidad | Rotación interna cadera 90-90', 1, '8/lado', 0),
        _ex('eg_s4d1_mob_flex_esc', 'Movilidad | Flexiones escapulares', 1, '10', 0),
        _ex('eg_s4d1_sent_1', 'Sentadilla libre barra alta', 2, '10', 0),
        _ex('eg_s4d1_sent_2', 'Sentadilla libre barra alta', 1, '8', 0),
        _ex('eg_s4d1_hip_thrust', 'Hip Thrust', 4, '14', 0),
        _ex('eg_s4d1_sent_bulg', 'Sentadilla búlgara con mancuerna', 3, '10/lado', 0),
        _ex('eg_s4d1_kb_clean', 'Kettlebell clean and press', 3, '10/lado', 0),
        _ex('eg_s4d1_patada_gluteo', 'Patada glúteo en polea cuadrupedia', 2, '14/lado', 0),
      ],
      2: [
        ...
        _ex('eg_s4d2_mob_shoulder_car', 'Movilidad | Shoulder CAR', 1, '10', 0),
        _ex('eg_s4d2_mob_kb_halos', 'Movilidad | Kettlebell halos', 1, '8/lado', 0),
        _ex('eg_s4d2_flexiones_max', 'Flexiones', 1, 'Máximas', 0),
        _ex('eg_s4d2_remo_gironda', 'Remo gironda en polea', 3, '14', 0),
        _ex('eg_s4d2_press_hombro', 'Press de hombro con mancuernas', 3, '14', 0),
        _ex('eg_s4d2_facpull', 'Facpull en polea', 3, '16', 0),
        _ex('eg_s4d2_core_crunch_1', 'Core | Crunch', 3, '30"', 30),
        _ex('eg_s4d2_core_crunch_2', 'Core | Crunch alternando', 3, '30"', 30),
        _ex('eg_s4d2_plancha_hombro', 'Plancha con toques de hombro', 3, '30"', 30),
        _ex('eg_s4d2_core_vups', 'Core | V ups', 3, '30"', 30),
      ],
      3: [
        _ex('eg_s4d3_hiit_1', 'HIIT | Drop squats con disco', 1, '30"', 30),
        _ex('eg_s4d3_hiit_2', 'HIIT | Sentadilla + toque rodilla', 1, '30"', 30),
        _ex('eg_s4d3_hiit_3', 'HIIT | Mountain climbers', 1, '30"', 30),
        _ex('eg_s4d3_hiit_4', 'HIIT | Scissor jumps', 1, '30"', 30),
        _ex('eg_s4d3_hiit_5', 'HIIT | Rocket launch taps', 1, '30"', 30),
      ],
      4: [
        _ex('eg_s4d4_core_limb', 'Core | Limb lifts', 2, '8/lado', 0),
        _ex('eg_s4d4_est_aduct', 'Estiramiento | Aductores (Mariposa)', 2, '30"', 0),
        _ex('eg_s4d4_est_standing', 'Estiramiento | Standing reach down', 2, '30"', 0),
      ],
      5: [
        _ex('eg_s4d5_mob_cossack', 'Movilidad | Cossack squat', 1, '8/lado', 0),
        _ex('eg_s4d5_mob_bisagra', 'Movilidad | Bisagra de cadera', 1, '10', 0),
        _ex('eg_s4d5_mob_esc', 'Movilidad | Movimientos escapulares', 1, '10', 0),
        _ex('eg_s4d5_mob_logback', 'Movilidad | Log Backback', 1, '8/lado', 0),
        _ex('eg_s4d5_pm_1', 'Peso muerto convencional', 2, '8', 0),
        _ex('eg_s4d5_pm_2', 'Peso muerto convencional', 2, '10', 0),
        _ex('eg_s4d5_kb_squat_remo', 'Sentadilla kettlebell + remo mentón', 4, '10', 0),
        _ex('eg_s4d5_dominadas_max', 'Dominadas', 1, 'Máximas', 0),
        _ex('eg_s4d5_pistol_disco', 'Pistol squat con disco', 2, '4/lado', 0),
        _ex('eg_s4d5_core_passthrough', 'Core | Pass through con mancuernas', 3, '10/lado', 30),
      ],
      6: [
        _ex('eg_s4d6_hiit_1', 'HIIT | Fast feet', 1, '30"', 30),
        _ex('eg_s4d6_hiit_2', 'HIIT | Remo con salto y resistencia', 1, '30"', 30),
        _ex('eg_s4d6_hiit_3', 'HIIT | Lateral lunge drop', 1, '30"', 30),
        _ex('eg_s4d6_hiit_4', 'HIIT | Rocket launch squats', 1, '30"', 30),
        _ex('eg_s4d6_hiit_5', 'HIIT | Skater jumps', 1, '30"', 30),
      ],
      7: [
        _ex('eg_s4d7_aduct_copenh', 'Aductores | Plancha Copenhague', 2, '30"/lado', 0),
        _ex('eg_s4d7_est_sitting', 'Estiramiento | Sitting reach', 2, '30"', 0),
        _ex('eg_s4d7_mob_cat', 'Movilidad | Cat camel', 2, '10', 0),
        _ex('eg_s4d7_est_tricep', 'Estiramiento | Tríceps', 2, '15"/lado', 0),
        _ex('eg_s4d7_est_muneca', 'Estiramiento | Muñecas', 2, '15"/lado', 0),
        _ex('eg_s4d7_est_standing_fwd', 'Estiramiento | Standing reach down forward', 2, '30"', 0),
      ],
    },
  ]
};
