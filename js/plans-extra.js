...
(function () {
  ...
  // ═══ SEMANAS 7-12 — placeholder (pendientes de extracción) ═══
  // Reusan S6 D1-D5 + Cardio LISS para D6 hasta que se carguen
  for (let s = 7; s <= 12; s++) {
    W[s] = {
      1: W[6][1],
      2: W[6][2],
      4: W[6][4],
      5: W[6][5],
      6: [_ex(`woods_s${s}d6_liss`, 'Cardio LISS', 1, '60\'', 0, 'Jogging, trekking, nadar, bici, etc')],
    };
  }
  ...
  WORKOUT_PLANS.woods = {
    ...
    planType: 'phased',
    weeks: 12,
    description: 'Plan 12 semanas estilo CrossFit/funcional con WOD, AMRAP, Tabata, ergómetros (SkiErg, RowErg), trineo, wall ball y KB. S1 = 4 días. S2-S12 = 5 días (añade Cardio LISS 60\' los D6). Bloques: S1-S4 Endurance/Fuerza/Performance, S5-S6 Bodybuilding/Development. S7-S12 pendientes de cargar.',
    trainingDays: [1, 2, 4, 5, 6],
    dayMeta: {
